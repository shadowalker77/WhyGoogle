...
public abstract class MyFragmentStateAdapter extends
        RecyclerView.Adapter<MyFragmentViewHolder> implements StatefulAdapter {
    // State saving config
    ...
    /**
     * @param fragmentActivity if the {@link NonFinalViewPager2} lives directly in a
    ...
    /**
     * @param fragment if the {@link NonFinalViewPager2} lives directly in a {@link Fragment} subclass.
     *
    ...
    /**
     * @param fragmentManager of {@link NonFinalViewPager2}'s host
     * @param lifecycle of {@link NonFinalViewPager2}'s host
     *
     * @see androidx.viewpager2.adapter.FragmentStateAdapter#FragmentStateAdapter(FragmentActivity)
     * @see androidx.viewpager2.adapter.FragmentStateAdapter#FragmentStateAdapter(Fragment)
     */
    ...
    @NonNull
    @Override
    public final MyFragmentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return MyFragmentViewHolder.create(parent);
    }

    @Override
    public final void onBindViewHolder(final @NonNull MyFragmentViewHolder holder, int position) {
...
//            removeFragment(boundItemId);
    ...
    @Override
    public final void onViewAttachedToWindow(@NonNull final MyFragmentViewHolder holder) {
        placeFragmentInViewHolder(holder);
        gcFragments();
    }
     ...
     */
    @SuppressWarnings("WeakerAccess") // to avoid creation of a synthetic accessor
    void placeFragmentInViewHolder(@NonNull final MyFragmentViewHolder holder) {
    ...
    @Override
    public final void onViewRecycled(@NonNull MyFragmentViewHolder holder) {
        final int viewHolderId = holder.getContainer().getId();
        final Long boundItemId = itemForViewHolder(viewHolderId); // item currently bound to the VH
//        if (boundItemId != null) {
//            removeFragment(boundItemId);
...
//        }
    ...
    @Override
    public final boolean onFailedToRecycleView(@NonNull MyFragmentViewHolder holder) {
        /*
    ...
    class FragmentMaxLifecycleEnforcer {
        private NonFinalViewPager2.OnPageChangeCallback mPageChangeCallback;
        private RecyclerView.AdapterDataObserver mDataObserver;
        private LifecycleEventObserver mLifecycleObserver;
        private NonFinalViewPager2 mViewPager;
        ...
        void register(@NonNull RecyclerView recyclerView) {
            ...
            mPageChangeCallback = new NonFinalViewPager2.OnPageChangeCallback() {
                @Override
            ...
            mDataObserver = new MyFragmentStateAdapter.DataSetChangeObserver() {
                @Override
        ...
        void unregister(@NonNull RecyclerView recyclerView) {
            NonFinalViewPager2 viewPager = inferViewPager(recyclerView);
        ...
        void updateFragmentMaxLifecycle(boolean dataSetChanged) {
            ...
            if (mViewPager.getScrollState() != NonFinalViewPager2.SCROLL_STATE_IDLE) {
        ...
        @NonNull
        private NonFinalViewPager2 inferViewPager(@NonNull RecyclerView recyclerView) {
